...
export function Home(){
	...
	const [userProfessional, setUserProfessional] = useState<Professional | null>(null);
	...
	useEffect(() => {
		api.get("/professional/").then(response => {
			...
			if (matchedProfessional) {
				...
				setImageUri(matchedProfessional.profile_picture); // Assume que profile_picture é a chave para a imagem
		} else {
	...
	return (
		<S.Container showsVerticalScrollIndicator={false}>
			<S.Header>
				...
				<S.ImageProfile source={{uri: imageUri || 'https://www.kindpng.com/picc/m/24-248253_user-profile-default-image-png-clipart-png-download.png'}} />
			</S.Header>
